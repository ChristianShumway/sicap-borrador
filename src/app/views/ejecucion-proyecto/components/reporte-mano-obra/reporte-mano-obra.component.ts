...
@Component({
  selector: 'app-reporte-mano-obra',
  templateUrl: './reporte-mano-obra.component.html',
  styleUrls: ['./reporte-mano-obra.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class ReporteManoObraComponent implements OnInit {
      ...
      this.catalogo.map( (concepto: ConceptoManoObra) => {
        if(concepto.cantidadCapturada !== 0){
          const conceptoModificado = {
            ...
            idUsuarioModificado: this.idUsuarioLogeado
          };
