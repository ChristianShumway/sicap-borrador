...
@Component({
  selector: 'app-lista-reporte-maquinaria-equipo',
  templateUrl: './lista-reporte-maquinaria-equipo.component.html',
  styleUrls: ['./lista-reporte-maquinaria-equipo.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class ListaReporteMaquinariaEquipoComponent implements OnInit {
