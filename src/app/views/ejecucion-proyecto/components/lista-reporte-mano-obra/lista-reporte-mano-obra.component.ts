...
@Component({
  selector: 'app-lista-reporte-mano-obra',
  templateUrl: './lista-reporte-mano-obra.component.html',
  styleUrls: ['./lista-reporte-mano-obra.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class ListaReporteManoObraComponent implements OnInit {
  ...
  getTotalShow(reportes){
    ...
    reportes.map( reporte => {
      // console.log(reporte);
      reporte.detManoObra.map( concepto => {
