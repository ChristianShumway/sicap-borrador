...
@Component({
  selector: 'app-modificar-reporte-mano-obra',
  templateUrl: './modificar-reporte-mano-obra.component.html',
  styleUrls: ['./modificar-reporte-mano-obra.component.scss'],
  changeDetection: ChangeDetectionStrategy.Default
})
export class ModificarReporteManoObraComponent implements OnInit {
